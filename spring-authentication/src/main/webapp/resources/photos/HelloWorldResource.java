...
public class HelloWorldResource {
	private static final String tmskey="XXXX";
    ...
    public String getYouTubeURL(String movie) {
		...
		try {
			...
			String url_string = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + URLEncoder.encode(movie, "UTF-8")+"&order=date&videoEmbeddable=true&type=video&key=XXX";
